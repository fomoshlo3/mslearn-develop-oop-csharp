...
public class AccountReportGenerator : IMonthlyReportGenerator, IQuarterlyReportGenerator, IYearlyReportGenerator
{
    ...
    {
        Console.WriteLine($"Generating monthly report for account: {_account.AccountNumber}");
    ...
    {
        Console.WriteLine($"Generating previous month report for account: {_account.AccountNumber}");
