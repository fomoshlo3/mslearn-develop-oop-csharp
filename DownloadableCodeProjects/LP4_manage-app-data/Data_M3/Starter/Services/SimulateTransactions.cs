...
//         monthlyTransactions[0] = new Transaction(middleOfMonth, new TimeOnly(12, 00), runningBalance1, semiMonthlyPaycheck, account1.AccountNumber, account1.AccountNumber, "Deposit", "Bi-monthly salary deposit");
//         runningBalance1 += semiMonthlyPaycheck;
//         monthlyTransactions[1] = new Transaction(endOfMonth, new TimeOnly(12, 00), runningBalance1, semiMonthlyPaycheck, account1.AccountNumber, account1.AccountNumber, "Deposit", "Bi-monthly salary deposit");
//         runningBalance1 += semiMonthlyPaycheck;
...
//         monthlyTransactions[2] = new Transaction(firstDayOfMonth, new TimeOnly(12, 00), runningBalance1, transferToSavings, account1.AccountNumber, account2.AccountNumber, "Withdraw", "Transfer checking to savings account");
//         monthlyTransactions[3] = new Transaction(firstDayOfMonth, new TimeOnly(12, 00), runningBalance2, transferToSavings, account2.AccountNumber, account2.AccountNumber, "Deposit", "Transfer checking to savings account");
//         runningBalance1 -= transferToSavings;
//         runningBalance2 += transferToSavings;


//         // Use account1 to generate a withdraw transaction for rent on the first day of the month.
//         monthlyTransactions[4] = new Transaction(firstDayOfMonth, new TimeOnly(12, 00), runningBalance1, rent, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay rent");
//         runningBalance1 -= rent;
...
//         monthlyTransactions[5] = new Transaction(saturday1, new TimeOnly(21, 00), runningBalance1, entertainment1, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Debit card purchase");
//         runningBalance1 -= entertainment1;
//         monthlyTransactions[6] = new Transaction(saturday2, new TimeOnly(21, 00), runningBalance1, entertainment2, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Debit card purchase");
//         runningBalance1 -= entertainment2;
//         monthlyTransactions[7] = new Transaction(saturday3, new TimeOnly(21, 00), runningBalance1, entertainment3, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Debit card purchase");
//         runningBalance1 -= entertainment3;
//         monthlyTransactions[8] = new Transaction(saturday4, new TimeOnly(21, 00), runningBalance1, entertainment4, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Debit card purchase");
//         runningBalance1 -= entertainment4;
...
//         monthlyTransactions[9] = new Transaction(new DateOnly(year, month, 20), new TimeOnly(12, 00), runningBalance1, monthlyGasElectric, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay gas and electric bill");
//         monthlyTransactions[10] = new Transaction(new DateOnly(year, month, 20), new TimeOnly(12, 00), runningBalance1, monthlyWaterSewer, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay water and sewer bill");
//         monthlyTransactions[11] = new Transaction(new DateOnly(year, month, 20), new TimeOnly(12, 00), runningBalance1, monthlyWasteManagement, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay waste management bill");
//         monthlyTransactions[12] = new Transaction(new DateOnly(year, month, 20), new TimeOnly(12, 00), runningBalance1, monthlyHealthClub, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay health club membership");
...
//         double weeklyCash = 400.00;
//         monthlyTransactions[13] = new Transaction(monday1, new TimeOnly(9, 00), runningBalance1, weeklyCash, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Withdraw for expenses");
//         monthlyTransactions[14] = new Transaction(monday2, new TimeOnly(9, 00), runningBalance1, weeklyCash, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Withdraw for expenses");
//         monthlyTransactions[15] = new Transaction(monday3, new TimeOnly(9, 00), runningBalance1, weeklyCash, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Withdraw for expenses");
//         monthlyTransactions[16] = new Transaction(monday4, new TimeOnly(9, 00), runningBalance1, weeklyCash, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Withdraw for expenses");

//         // Generate a withdraw transaction for a credit card bill on the last day of the month.
//         monthlyTransactions[17] = new Transaction(lastDay, new TimeOnly(12, 00), runningBalance1, creditCardBill, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay credit card bill");

//         // Generate a refund transaction for an overcharge on the 5th of the month.
//         monthlyTransactions[18] = new Transaction(new DateOnly(year, month, 5), new TimeOnly(12, 00), runningBalance1, 100.00, account2.AccountNumber, account1.AccountNumber, "Refund", "Refund for overcharge");

//         // Generate a bank fee transaction on the 3rd and 10th of the month.
//         monthlyTransactions[19] = new Transaction(new DateOnly(year, month, 3), new TimeOnly(12, 00), runningBalance1, -50.00, account1.AccountNumber, account1.AccountNumber, "Fee", "Monthly fee");
//         monthlyTransactions[20] = new Transaction(new DateOnly(year, month, 10), new TimeOnly(12, 00), runningBalance1, -50.00, account1.AccountNumber, account1.AccountNumber, "Fee", "Monthly fee");
...
//         // Generate withdraw transactions for monthly bills on the 20th of the month. Bills include gas and electric, water and sewer, waste management, and health club membership.
//         DateOnly billDate = new DateOnly(endDate.Year, endDate.Month, 20);
//         if (billDate <= endDate)
//         {
//             monthlyTransactions[transactionIndex++] = new Transaction(billDate, new TimeOnly(12, 00), monthlyGasElectric, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay gas and electric bill");
//             monthlyTransactions[transactionIndex++] = new Transaction(billDate, new TimeOnly(12, 00), monthlyWaterSewer, account1.AccountNumber, account1.AccountNumber, "Withdraw", "Auto-pay water and sewer bill");
...
//         // Generate a refund transaction for an overcharge on the 5th of the month.
//         DateOnly refundDate = new DateOnly(endDate.Year, endDate.Month, 5);
...
//         // Generate a bank fee transaction on the 3rd and 10th of the month.
//         DateOnly feeDate1 = new DateOnly(endDate.Year, endDate.Month, 3);
//         DateOnly feeDate2 = new DateOnly(endDate.Year, endDate.Month, 10);
//         if (feeDate1 <= endDate)
//         {
//             monthlyTransactions[transactionIndex++] = new Transaction(feeDate1, new TimeOnly(12, 00), -50.00, account1.AccountNumber, account1.AccountNumber, "Fee", "Monthly fee");
//         }
